...
#pragma omp single nowait
	{
	  ...
	  if(global_error<1.0)
		...
		{
		  printf("time=%f  dt=%f  global_error=%f, hfactor=%f\n",*time,dt,global_error,hfactor);	  
		  information_step=0;
		}
	      information_step++;
